...
$t['Audios'] = "Audios";
$t['Audios and Videos'] = "Audios and Lessons";
$t['Audio-Gallery by Date'] = "Audio-Gallery by Date";
$t['Authenticated users can comment videos'] = "Authenticated users can comment lessons";
$t['Authenticated users can upload videos'] = "Authenticated users can upload lessons";
$t['Auto'] = "Auto";
$t['Autoplay'] = "Autoplay";
$t['Autoplay Next Video'] = "Autoplay Next Lesson";
$t['Autoplay Next Video URL'] = "Autoplay Next Lesson URL";
$t['Autoplay Video on Load Page'] = "Autoplay Lesson on Load Page";
$t['Autoplay ended'] = "Autoplay ended";
$t['Autoplay next-video-order'] = "Autoplay next-lesson-order";
$t['Balance'] = "Balance";
...
$t['Browse'] = "Browse";
$t['Browse Channels'] = "Browse Classrooms";
$t['By associating groups with this user, they will be able to see all the videos that are related to this group'] = "By associating groups with this user, they will be able to see all the lessons that are related to this group";
$t['By linking groups to this video, it will no longer be public and only users in the same group will be able to watch this video'] = "By linking groups to this video, it will no longer be public and only users in the same group will be able to watch this lesson";
$t['By name'] = "By name";
$t['Can Stream Videos'] = "Can Stream Lessons";
$t['Can Upload Videos'] = "Can Upload Lessons";
$t['Categories'] = "Subjects";
$t['Category'] = "Subject";
$t['Category Form'] = "Subject Form";
$t['Category to display this Ad'] = "Subject to display this Ad";
$t['Center'] = "Center";
$t['Category-Gallery'] = "Subject-Gallery";
$t['Change Playlist Name'] = "Change Lesson Plan Name";
$t['Change Style'] = "Change Style";
$t['Channel'] = "Classroom";
$t['Channels'] = "Classrooms";
$t['Channel Name'] = "Classroom Name";
$t['Channel name already exists'] = "Classroom name already exists";
...
$t['Direct Import Local Videos'] = "Direct Import Local Lessons";
...
$t['Disable right-click-prevention on video and allow downloading'] = "Disable right-click-prevention on lesson and allow downloading";
$t['Do not forget to save after choose your theme'] = "Do not forget to save after choose your theme";
$t['Don´t like this video? Sign in to make your opinion count.'] = "Don´t like this lesson? Sign in to make your opinion count.";
$t['Down'] = "Down";
$t['Download'] = "Download";
$t['Download video'] = "Download Lesson";
...
$t['Edit'] = "Edit";
$t['Edit Video'] = "Edit Lesson";
$t['Email can not be blank'] = "Email can not be blank";
$t['Embed'] = "Embed";
$t['Embed a video link'] = "Embed a lesson link";
$t['Embeded'] = "Embeded";
...
$t['Go to manager videos page!'] = "Go to manager lessons page!";
$t['Google Ad Sense'] = "Google Ad Sense";
$t['Group'] = "Group";
$t['Groups that can see this video'] = "Groups that can see this lesson";
$t['Groups That Can See This Stream'] = "Groups That Can See This Lesson Stream";
...
$t['I would like to share this video with you:'] = "I would like to share this lesson with you:";
$t['ID'] = "ID";
$t['ID can not be empty'] = "ID can not be empty";
$t['ID can\'t be blank'] = "ID can't be blank";
$t['Icon'] = "Icon";
$t['If you can\'t view this video, your browser does not support HTML5 videos'] = "If you can't view this lesson, your browser does not support HTML5 videos";
...
$t['Like this video? Sign in to make your opinion count.'] = "Like this lesson? Sign in to make your opinion count.";
$t['Listed Transmition'] = "Listed Transmition";
$t['Live'] = "Live";
$t['Live Chat']  = "Live Chat";
$t['LIVE NOW']  = "LIVE NOW";
$t['Live Video'] = "Live Lesson";
$t['Loading...'] = "Loading...";
$t['Local File'] = "Local File";
$t['Login'] = "Login";
$t['Logoff'] = "Logoff";
$t['Make it public'] = "Make it public";
$t['Make sure that the video you are going to download has a duration of less than %d minute(s)!'] = "Make sure that the lesson you are going to download has a duration of less than %d minute(s)!";
...
$t['My Channel'] = "My Classroom";
$t['My list']  = "My list";
$t['My videos'] = "My Lessons";
$t['My Subscribers'] = "My Students";
$t['Name'] = "Name";
$t['Name can\'t be blank'] = "Name can't be blank";
$t['New Category'] = "New Subject";
...
$t['Notify Subscribers'] = "Notify Students";
$t['Off']  = "Off";
$t['On']  = "On";
...
$t['Parent-Category'] = "Parent-Subject";
$t['Password'] = "Password";
...
$t['Playlist name?'] = "Lesson Plan name?";
...
$t['Remove'] = "Remove";
$t['Remove Autoplay Next Video'] = "Remove Autoplay Next Lesson";
$t['Rename'] = "Rename";
$t['Reply'] = "Reply";
...
$t['Select an icon for the category'] = "Select an icon for the subject";
...
$t['Sorry'] = "Sorry";
$t['Sorry you not able to download videos right now!'] = "Sorry you are not able to download lessons right now!";
$t['Sorry!'] = "Sorry!";
...
$t['Subscribe'] = "Enroll";
$t['Subscribed'] = "Enrolled";
$t['Subscribed to'] = "Student to";
$t['Subscribes'] = "Students";
$t['Subscriptions'] = "Enrollments";
...
$t['The original file for this video does not exists anymore'] = "The original file for this lesson does not exists anymore";
...
$t['This video will cost you %s point(s)'] = "This lesson will cost you %s point(s)";
...
$t['To view this video please enable JavaScript, and consider upgrading to a web browser that'] = "To view this lesson please enable JavaScript, and consider upgrading to a web browser that";
$t['Today'] = "Today";
$t['Today Views'] = "Today Views";
$t['Total Duration Videos (Minutes)'] = "Total Duration of this Lesson (Minutes)";
$t['Total Subscriptions'] = "Total Enrollments";
$t['Total Users'] = "Total Users";
$t['Total Video Comments'] = "Total Lesson Comments";
$t['Total Videos'] = "Total Lessons";
$t['Total Videos Dislikes'] = "Total Lesson Dislikes";
$t['Total Videos Likes'] = "Total Lesson Likes";
$t['Total Videos Views'] = "Total Lesson Views";
...
$t['Video'] = "Lesson";
$t['Video Advertising'] = "Lesson Advertising";
$t['Video Chart'] = "Lesson Chart";
$t['Video Form'] = "Lesson Form";
$t['Video Link'] = "Lesson Link";
$t['Video Title'] = "Lesson Title";
$t['Video URL'] = "Lesson URL";
$t['Video can not be empty'] = "Video can not be empty";
$t['Video not found'] = "Video not found";
$t['Video re-encoding!'] = "Video re-encoding!";
$t['Videos'] = "Lessons";
$t['Videos linked'] = "Lessons linked";
$t['View'] = "View";
...
$t['You can not stream live videos'] = "You can not stream live lessons";
...
$t['You cannot comment on videos'] = "You cannot comment on lessons";
$t['You could not use your balance to watch this video'] = "You could not use your balance to watch this lesson";
...
$t['You must login to be able to comment on videos'] = "You must login to be able to comment on lessons";
$t['You must make this video public or select a group to see your video!'] = "You must make this lesson public or select a group to see your lesson!";
...
$t['You will not be able to recover these videos!'] = "You will not be able to recover these lessons!";
$t['You will not be able to recover this action!'] = "You will not be able to recover this action!";
$t['You will not be able to recover this category!'] = "You will not be able to recover this subject!";
...
$t['You will not be able to recover this video!'] = "You will not be able to recover this lesson!";
...
$t['You will support this video with '] = "You will support this lesson with ";
...
$t['Your category has NOT been deleted!'] = "Your subject has NOT been deleted!";
$t['Your category has NOT been saved!'] = "Your subject has NOT been saved!";
$t['Your category has been deleted!'] = "Your subject has been deleted!";
$t['Your category has been saved!'] = "Your subject has been saved!";
...
$t['Allow Download My Videos'] = "Allow Download of My lessons";
$t['Allow Share My Videos'] = "Allow Sharinv of My lessons";
$t['Next video NOT set'] = "Next lesson is NOT set";
$t['Remove User Group'] = "Remove User Group";
$t['Add User Group'] = "Add User Group";
$t['%d Users linked'] = "%d Users linked";
$t['Sign out'] = "Sign out";
$t['Home'] = "Homeroom";
$t['Trending'] = "Illuminating";
...
$t['Video views - per Channel'] = "Lesson views - per Classroom";
$t['Comment thumbs up - per Person'] = "Comment thumbs up - per Student";
$t['Video thumbs up - per Channel'] = "Lesson thumbs up - per Classroom";
$t['Private'] = "Private";
$t['Owner'] = "Owner";
